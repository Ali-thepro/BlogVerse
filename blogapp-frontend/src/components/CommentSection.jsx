...
import { createComment, getPostComments } from '../redux/reducers/commentReducer';
      ...
      {user && (
        ...
        >
          ...
          <div className='flex justify-between items-center mt-5'>
            ...
            <Button className='focus:ring-0 bg-gradient-to-r from-blue-500 via-purple-500 to-red-500' outline type='submit'>
              Submit
            </Button>
          </div>
          <Notification />
